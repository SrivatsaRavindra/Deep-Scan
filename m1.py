...
# ✅ Load Pretrained ResNet152 with Fine-Tuning
...
model = models.Sequential([
    ...
    layers.Dense(1024, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=0.0005, l2=0.0005)),
    layers.BatchNormalization(),
   
    layers.Dense(512, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=0.0005, l2=0.0005)),
    layers.BatchNormalization(),
   
    layers.Dense(256, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=0.0005, l2=0.0005)),
    layers.BatchNormalization(),
   
    layers.Dense(128, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=0.0005, l2=0.0005)),
    layers.BatchNormalization(),
   
    layers.Dense(64, activation='relu', kernel_regularizer=regularizers.l1_l2(l1=0.0005, l2=0.0005)),
    layers.BatchNormalization(),
...
checkpoint = ModelCheckpoint('best_resnet152_model.h5', monitor='val_loss', save_best_only=True)
...
# ✅ Save the Model
model.save('resnet152_binary_classification_model.h5')
